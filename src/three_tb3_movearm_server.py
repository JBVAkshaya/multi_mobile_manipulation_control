...
if __name__ == '__main__':
    ...
    server = MoveArmServer('TBwOM_3/movearm', 'TBwOM_3/joint_trajectory_point', 'TBwOM_3/joint_states')
    now = rospy.get_rostime()
    rospy.loginfo("Current time movearm 3: %i  secs and %i nsecs", now.secs, now.nsecs)
