...
if __name__ == '__main__':
    ...
    client_base, goal_base = move_base_client()
    client_arm, goal_arm = move_arm_client()


    executor_base = ActionClientExecutor(client_base, goal_base, 'base')
    executor_arm = ActionClientExecutor(client_arm, goal_arm, 'arm')
    ...
    # Process the results
    result_base = executor_base.result
    # Process the result of action1

    result_arm = executor_arm.result